        ...
        <section className={styles.contact} id="contact">
            <div className={`${styles.contactContent} contact-content`}>
                <div className={styles.contactHeader}>
                    ...
                    <h2 className={styles.contactTitle}>Готов обсудить ваш проект</h2>
                    <p className={styles.contactSubtitle}>
                        Оставьте заявку или напишите мне в удобном мессенджере напрямую.
                    </p>
                </div>
                ...
                <div className={styles.contactGrid}>
                    ...
                    <div className={styles.contactButtonsWrapper}>
                        <h3 className={styles.contactButtonsText}>Или напишите мне напрямую:</h3>
